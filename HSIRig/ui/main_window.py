...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBoxRigConnection_2 = QtWidgets.QGroupBox(self.tab_2)
        self.groupBoxRigConnection_2.setGeometry(QtCore.QRect(30, 560, 421, 101))
        self.groupBoxRigConnection_2.setObjectName("groupBoxRigConnection_2")
        self.lblControlPort_2 = QtWidgets.QLabel(self.groupBoxRigConnection_2)
        self.lblControlPort_2.setGeometry(QtCore.QRect(0, 30, 131, 20))
        ...
        self.cmbBoxCommPortSelect_2 = QtWidgets.QComboBox(self.groupBoxRigConnection_2)
        self.cmbBoxCommPortSelect_2.setGeometry(QtCore.QRect(150, 30, 241, 24))
        self.cmbBoxCommPortSelect_2.setObjectName("cmbBoxCommPortSelect_2")
        self.btnRigConnect_2 = QtWidgets.QPushButton(self.groupBoxRigConnection_2)
        self.btnRigConnect_2.setGeometry(QtCore.QRect(180, 60, 101, 32))
        self.btnRigConnect_2.setObjectName("btnRigConnect_2")
        self.btnRigDisconnect_2 = QtWidgets.QPushButton(self.groupBoxRigConnection_2)
        self.btnRigDisconnect_2.setEnabled(False)
        self.btnRigDisconnect_2.setGeometry(QtCore.QRect(290, 60, 101, 32))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBoxRigConnection_2.setTitle(_translate("MainWindow", "Rig Controller Connection"))
        self.lblControlPort_2.setText(_translate("MainWindow", "Controller Port:"))
