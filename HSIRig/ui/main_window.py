...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(40, 22, 1391, 641))
        ...
        self.label.setGeometry(QtCore.QRect(80, 30, 51, 20))
        self.label.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.label.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label.setObjectName("label")
        self.btnCameraConnect = QtWidgets.QPushButton(self.groupBox)
        self.btnCameraConnect.setGeometry(QtCore.QRect(200, 60, 91, 32))
        ...
        self.chkCalibration.setGeometry(QtCore.QRect(66, 130, 101, 21))
        ...
        self.btnRigDisconnect_2.setGeometry(QtCore.QRect(300, 190, 91, 32))
        ...
        self.btnRigConnect_2.setGeometry(QtCore.QRect(200, 190, 91, 32))
        self.btnRigConnect_2.setObjectName("btnRigConnect_2")
        self.lblControlPort_2 = QtWidgets.QLabel(self.groupBox)
        self.lblControlPort_2.setGeometry(QtCore.QRect(40, 160, 91, 20))
        ...
        self.cmbBoxCommPortSelect_2.setMaxVisibleItems(10)
        self.cmbBoxCommPortSelect_2.setObjectName("cmbBoxCommPortSelect_2")
        self.chkSaveRawData = QtWidgets.QCheckBox(self.groupBox)
        self.chkSaveRawData.setGeometry(QtCore.QRect(270, 130, 121, 21))
        self.chkSaveRawData.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.chkSaveRawData.setChecked(True)
        self.chkSaveRawData.setObjectName("chkSaveRawData")
        self.chkSaveToFile = QtWidgets.QCheckBox(self.groupBox)
        self.chkSaveToFile.setGeometry(QtCore.QRect(180, 130, 81, 21))
        self.chkSaveToFile.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.chkSaveToFile.setChecked(True)
        self.chkSaveToFile.setObjectName("chkSaveToFile")
        self.chkSkipHoming = QtWidgets.QCheckBox(self.groupBox)
        self.chkSkipHoming.setGeometry(QtCore.QRect(66, 190, 101, 21))
        self.chkSkipHoming.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.chkSkipHoming.setObjectName("chkSkipHoming")
        self.groupBox_2 = QtWidgets.QGroupBox(self.tab_2)
        self.groupBox_2.setGeometry(QtCore.QRect(30, 230, 421, 211))
        self.groupBox_2.setObjectName("groupBox_2")
        self.label_3 = QtWidgets.QLabel(self.groupBox_2)
        self.label_3.setGeometry(QtCore.QRect(90, 20, 41, 20))
        ...
        self.label_4.setGeometry(QtCore.QRect(70, 50, 61, 20))
        self.label_4.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.label_4.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_4.setObjectName("label_4")
        self.label_5 = QtWidgets.QLabel(self.groupBox_2)
        self.label_5.setGeometry(QtCore.QRect(80, 80, 51, 20))
        self.label_5.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.label_5.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_5.setObjectName("label_5")
        self.label_6 = QtWidgets.QLabel(self.groupBox_2)
        self.label_6.setGeometry(QtCore.QRect(50, 110, 81, 20))
        self.label_6.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.label_6.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_6.setObjectName("label_6")
        self.label_7 = QtWidgets.QLabel(self.groupBox_2)
        self.label_7.setGeometry(QtCore.QRect(50, 140, 81, 20))
        ...
        self.label_8.setGeometry(QtCore.QRect(90, 40, 41, 20))
        ...
        self.line.setGeometry(QtCore.QRect(470, 40, 20, 561))
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(500, 460, 261, 131))
        ...
        self.line_2.setGeometry(QtCore.QRect(780, 40, 20, 561))
        self.line_2.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.tabWidget.addTab(self.tab_3, "")
        self.line_6 = QtWidgets.QFrame(self.centralwidget)
        self.line_6.setGeometry(QtCore.QRect(30, 680, 20, 71))
        self.line_6.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_6.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_6.setObjectName("line_6")
        self.line_7 = QtWidgets.QFrame(self.centralwidget)
        self.line_7.setGeometry(QtCore.QRect(1420, 680, 20, 71))
        self.line_7.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_7.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_7.setObjectName("line_7")
        self.line_9 = QtWidgets.QFrame(self.centralwidget)
        self.line_9.setGeometry(QtCore.QRect(40, 660, 1391, 20))
        self.line_9.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_9.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_9.setObjectName("line_9")
        self.btnUpdateSettings = QtWidgets.QPushButton(self.centralwidget)
        self.btnUpdateSettings.setGeometry(QtCore.QRect(60, 700, 131, 32))
        ...
        self.cmbBoxCommPortSelect_2.setCurrentIndex(-1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnOutputFolder.setText(_translate("MainWindow", "Set"))
        ...
        self.chkSaveRawData.setText(_translate("MainWindow", "Save as raw data   "))
        self.chkSaveToFile.setText(_translate("MainWindow", "Save to file"))
        self.chkSkipHoming.setText(_translate("MainWindow", "Skip Homing:      "))
        ...
        self.btnUpdateSettings.setText(_translate("MainWindow", "Update Settings"))
